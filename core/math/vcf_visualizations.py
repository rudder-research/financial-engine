...
def create_full_vcf_report(panel_df: pd.DataFrame, 
                          vector_results: dict,
...
from vcf_math_models import VCFMathEngine
...
def create_advanced_vcf_report(panel_df: pd.DataFrame, col_a: str, col_b: str):
    """
